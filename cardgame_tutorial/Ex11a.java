...
public class Ex11a extends CardGame implements GGMouseListener
{
  public enum Suit
  {
  ...
  public Ex11a()
  {
    ...
    while (true)
    {
      ...
      Hand[] sequence4 = hand.extractSequences(4);
      ...
      Hand[] sequence5 = hand.extractSequences(5);
