...
public class Player
{
  ...
  private static final String filename = userHome + FS + "sixtysix.properties";
  ...
  protected static boolean writeProperty(String val)
  {
    try
    {
  ...
  protected String readProperty(String key)
  {
    ...
    return prop.getProperty("Deck", "Bridge");
  }
